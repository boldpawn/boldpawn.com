---
title: "Sub-process L4-ICS2-06-01: Handle AEO notification (HTI) (2021-04-30) v1.30 - part 2"
...
section: "Swimlanes (lanes)"
chunk: 2
chunk_count: 6
generated: true
---

# Sub-process L4-ICS2-06-01: Handle AEO notification (HTI) (2021-04-30) v1.30 - part 2
...
- Carrier (AEOS)
- Person filing (AEOS)
- Trader Interface *(contains all process elements)*
